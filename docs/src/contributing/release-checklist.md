...
5. **Excluded Josh surfaces:** prove `&`, `jobs`, `fg`, `bg`, `import`, `export`, and remote imports fail; background assignment remains out of scope.
